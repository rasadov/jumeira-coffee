...
var order = (function($) {
    ...
    function _changeDelivery() {
        var $item = ui.$delivery.btn.filter(':checked'),
            ...
            deliveryProcent = freeDelivery.enabled ? 0 :  cartSumma * +$item.attr('data-procent'),	
            fullSumma = deliverySumma + cartSumma - deliveryProcent,

            alert =
                freeDelivery.enabled
                    ?   'Мы дарим Вам бесплатную доставку!<hr> Общая сумма заказа: <span>' + cartSumma + ' рублей </span>'

                    :
                        'Сумма заказа <span>' + cartSumma + ' рублей. </span><br>' +
						'Сумма доставки <span>' + deliverySumma + ' рублей. </span><br>' +
						'Скидка на самовывоз <span>' + deliveryProcent + ' рублей. </span><hr>' +
                        'Общая сумма заказа: <span>' + fullSumma  + ' рублей </span>';
